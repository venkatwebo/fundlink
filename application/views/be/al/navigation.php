            ...
            <ul class="nav pcoded-inner-navbar">
                ...
                <li data-username="Menu levels Menu level 2.1 Menu level 2.2" class="nav-item pcoded-hasmenu">
                    ...
                    <ul class="pcoded-submenu">
                        <li class=""><a href="./sample-page.html" class="">Menu Level 2.1</a></li>
                        <li class="pcoded-hasmenu">
                            <a href="javascript:" class="">Menu level 2.2</a>
                            <ul class="pcoded-submenu">
                                <li class=""><a href="./sample-page.html" class="">Menu level 3.1</a></li>
                                <li class=""><a href="./sample-page.html" class="">Menu level 3.2</a></li>
                            </ul>
                        </li>
                    </ul>
                </li>
